      ...
      <section className="isolate">
        ...
        <div className="relative isolate -z-10">
          ...
          >
            ...
            <svg
              x="50%"
              y={-1}
              className="overflow-visible fill-zinc-50 dark:fill-zinc-900/60"
            >
              <path
              ...
              <div className="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                <div className="w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                  ...
                  <p className="relative mt-6 text-lg leading-8 text-zinc-600 dark:text-zinc-400 sm:max-w-md lg:max-w-none">
                    ...
                    that&apos;s when our genius CEO, Mr. Mahdi Elmi had the
                    audacity to tackle such a project and the rest is history as
                    you know.
                  </p>
                </div>
        ...
        <div className="relative isolate -z-10 mt-32 sm:mt-48">
          ...
          {/* <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <h2 className="text-center text-lg font-semibold leading-8 dark:text-zinc-50 text-zinc-900">
              Trusted by the world’s most innovative teams
            </h2>
            <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
              <Image
                className="col-span-2 max-h-12 w-full object-contain lg:col-span-1"
                src="https://tailwindui.com/img/logos/158x48/transistor-logo-zinc-900.svg"
                alt="Transistor"
                width={158}
                height={48}
              />
              <Image
                className="col-span-2 max-h-12 w-full object-contain lg:col-span-1"
                src="https://tailwindui.com/img/logos/158x48/reform-logo-zinc-900.svg"
                alt="Reform"
                width={158}
                height={48}
              />
              <Image
                className="col-span-2 max-h-12 w-full object-contain lg:col-span-1"
                src="https://tailwindui.com/img/logos/158x48/tuple-logo-zinc-900.svg"
                alt="Tuple"
                width={158}
                height={48}
              />
              <Image
                ...
                src="https://tailwindui.com/img/logos/158x48/savvycal-logo-zinc-900.svg"
                alt="SavvyCal"
                width={158}
                height={48}
              />
              <Image
                ...
                src="https://tailwindui.com/img/logos/158x48/statamic-logo-zinc-900.svg"
                alt="Statamic"
                width={158}
                height={48}
              />
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
            <h2 className="text-3xl font-bold tracking-tight dark:text-zinc-50 text-zinc-900 sm:text-4xl">
              From the blog
            </h2>
            <p className="mt-2 text-lg leading-8 dark:text-zinc-400 text-zinc-600">
